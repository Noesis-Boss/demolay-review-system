  ...
  return (
    <div className="min-h-screen" style={{ background: LIGHT_BLUE_BG }}>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-6 p-4 rounded-lg" style={{ background: `${AZ_GOLD}30`, border: `2px solid ${AZ_GOLD}` }}>
          <p className="text-center mb-4" style={{ color: AZ_BLUE }}>View aggregate results</p>
          <Link
            to="/demolay-review/results"
            className="block w-full text-center px-6 py-3 rounded-lg font-semibold text-white"
