...
export default function Landing() {
  ...
  const handleLogout = () => {
    localStorage.removeItem("reviewToken");
    setRedirecting(true);
    // Redirect to logout API which clears Google session then redirects to auth
      ...
      <div className="min-h-screen" style={{ background: `linear-gradient(135deg, ${AZ_BLUE}20 0%, ${AZ_RED}20 50%, ${AZ_GOLD}15 100%)` }}>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-lg" style={{ color: AZ_BLUE }}>{redirecting ? "Redirecting to login..." : "Loading..."}</p>
          </div>
        </div>
      </div>
    );
